...
import Bagalkotdata from'../src/topojsons/Districts/DistrictsData/Bagalkotedata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function AssemblyListBagalkot  (){
  const classes = useStyles();

  const navigate = useNavigate()
  
  const submit = (id) => {
    navigate(`/population-graph/Bagalkote/${id}`)
  }
  ...
  return (
    ...
    <Toolbar style={{ display: "flex", alignItems: "center" }}>
        ...
        <Typography
          ...
          <Avatar sx={{ bgcolor: "green" }}>BK</Avatar>
        </Toolbar>
...
export default AssemblyListBagalkot;