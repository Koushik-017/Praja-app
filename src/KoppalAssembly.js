...
import Koppaldata from'./topojsons/Districts/DistrictsData/Koppaladata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function KoppalAssembly (){
  const classes = useStyles();
  const navigate = useNavigate()
  const submit = (id) => {
    navigate(`/population-graph/Koppal/${id}`)
  }
...
>
    ...
    <Avatar sx={{ bgcolor: "green" }}>KP</Avatar>
    </Toolbar>
