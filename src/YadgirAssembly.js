...
import yadgirdata from'./topojsons/Districts/DistrictsData/yadgirdata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function YadgirAssembly (){
  const classes = useStyles();
  const navigate = useNavigate()
  const submit = (id) => {
    navigate(`/population-graph/Yadgir/${id}`)
  }
...
>
    ...
    <Avatar sx={{ bgcolor: "green" }}>YG</Avatar>
    </Toolbar>
