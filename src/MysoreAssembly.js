...
import Mysoredata from'./topojsons/Districts/DistrictsData/Mysoredata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function MysoreAssembly (){
  const classes = useStyles();
  const navigate = useNavigate()
  const submit = (id) => {
    navigate(`/population-graph/Mysore/${id}`)
  }
  ...
  const column1 = districtData.assembly_constituencies.slice(0, 10);
  // const column2 = districtData.assembly_constituencies.slice(6,);
...
>
    ...
    <Avatar sx={{ bgcolor: "green" }}>MS</Avatar>
    </Toolbar>
