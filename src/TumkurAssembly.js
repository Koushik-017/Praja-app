...
import Tumkurdata from'./topojsons/Districts/DistrictsData/Tumkurdata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function TumkurAssembly (){
  const classes = useStyles();
  const navigate = useNavigate()
  const submit = (id) => {
    navigate(`/population-graph/Tumkur/${id}`)
  }
...
>
    ...
    <Avatar sx={{ bgcolor: "green" }}>TK</Avatar>
    </Toolbar>
