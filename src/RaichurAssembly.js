...
import Raichurdata from'./topojsons/Districts/DistrictsData/Raichurdata.json';
...
const useStyles = makeStyles((theme) => ({
 ...
 function RaichurAssembly (){
  const classes = useStyles();
  const navigate = useNavigate()
  const submit = (id) => {
    navigate(`/population-graph/Raichur/${id}`)
  }
...
>
    ...
    <Avatar sx={{ bgcolor: "green" }}>RC</Avatar>
    </Toolbar>
...
export default RaichurAssembly ;